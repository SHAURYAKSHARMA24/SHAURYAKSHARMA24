<h1 align="center">Shaurya K Sharma</h1>
...
| Degree | BSc (Hons) Computing Systems, Ulster University, London |
| Location | London, UK |
| Open source | Contributor to OpenShield in the OWASP ecosystem |
| Main focus | Cloud-native development, security tooling, anomaly detection, backend services |
...
| Backend | Flask, Node.js, Azure Functions, REST APIs, validation, error handling |
| Cloud & Platforms | Azure Functions, Azure Blob Storage, Azure Cosmos DB, Application Insights, Azure App Service, GitHub Actions |
| Databases | Azure Cosmos DB, SQLite |
| Testing | pytest, API testing, CI build checks |
| Tools | Git, GitHub, GitHub Actions, Azure SDK, Vite, Postman |
